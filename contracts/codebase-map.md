...
Use [architecture](architecture.md) for boundary trade-offs and [debug](debug.md) for a failing behavior. Team lead separately verifies any later evidence.
