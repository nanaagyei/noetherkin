...
2. Distinguish learner contribution from supplied implementation and simulated exercises from real deployment, employment, users, production, or upstream acceptance. Quantify only actual measurements.
