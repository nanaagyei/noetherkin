...
Use [codebase-map](contract-codebase-map.md) for orientation and design-review (repository context: `contracts/design-review.md`; Related skill contract; omitted from this focused bundle.) for formal task-bound approval.
