...
Use codebase-map (repository context: `contracts/codebase-map.md`; Related skill contract; omitted from this focused bundle.) for orientation and [design-review](contract-design-review.md) for formal task-bound approval.
