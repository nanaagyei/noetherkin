...
| ONBOARD | Onboarding records goals, environment constraints, teaching preferences | Profile complete only after learner confirmation; BASELINE |
...
| PROJECT SELECTION | Projects offers catalog candidates; learner chooses | Pinned project and current-project; TASK ASSIGNMENT |
