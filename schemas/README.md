...
Eleven standalone JSON Schemas use Draft 2020-12. Protocol 3.0 adds tracks and current-track state while retained variants continue to validate immutable 2.0 records in migrated workspaces; the reviewed 1.0 files remain under archive/protocol-1.0/schemas. Each schema has closed objects, explicit required fields and no external or circular schema references.
